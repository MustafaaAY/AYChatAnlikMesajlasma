...
public class FirebaseMesajlasma extends FirebaseMessagingService {
...
//Oturum açık olup olmadığını anlamak için firebaseKullanici değişkenine değer döndürüyoruz
        ...
        if (firebaseKullanici != null && sented.equals(firebaseKullanici.getUid())){
    ...
    private void sendOreoNotification(RemoteMessage remoteMessage){
        ...
        Intent intent = new Intent(this, MesajActivity.class);
        ...
        Bildirim bildirim = new Bildirim(this);
        Notification.Builder builder = bildirim.getOreoNotification(title, body, pendingIntent,
                defaultSound, icon);
        ...
        bildirim.getManager().notify(i, builder.build());
